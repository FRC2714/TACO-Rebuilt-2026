...
public class Shooter extends SubsystemBase {
  ...
  static {
    ...
    shooterMap.put(3.4, new ShooterParams(2850, 1.2));
    shooterMap.put(4.2, new ShooterParams(3250, 1.3));
    shooterMap.put(4.5, new ShooterParams(3500, 1.3));
    shooterMap.put(4.65, new ShooterParams(3650, 1.4));
    shooterMap.put(5.2, new ShooterParams(3850, 1.4));
    shooterMap.put(6.0, new ShooterParams(4400, 1.5));
    shooterMap.put(7.0, new ShooterParams(4800, 1.6));
    shooterMap.put(8.0, new ShooterParams(5400, 1.7));
    shooterMap.put(9.0, new ShooterParams(6000, 1.8));
  }
